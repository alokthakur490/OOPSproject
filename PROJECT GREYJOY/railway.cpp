...
void firstPage()
{
    cout << "\n___________________________________________________________________________________" << endl;
        cout << "____________________________WELCOME TO NORTHERN  RAILWAYS______________________________" << endl
             << endl;
    ...
    case 2:
    {
        ...
        cout << "___________________Thanks for using NORTHERN RAILWAYS _____________________" << endl
             << endl;
        exit(0);
    }
    }
...
public:
    ...
    void dispBill()
    {
        ...
        cout << "____NORTHERN RAILWAYS_____" << endl;
    ...
    void dispDatabase()
    {
        ...
        cout << "____NORTHERN RAILWAYS _____" << endl;
...
public:
    ...
    void displayFoodReceipt()
    {
        ...
        cout << "\t|PNR Num\t\t|"
             ...
             << "Destination\t|"
             << endl;
        cout << "\t|" << cpnr << "\t\t|" << cname << "\t|" << cgen << "\t|JAL\t\t|" << cdest << "\t\t|" << endl
             << endl;
...
void mainMenu()
{
    ...
    cout << "\t\t Press 3 for pay Ticket  Charges and confirming booking     \t" << endl;
